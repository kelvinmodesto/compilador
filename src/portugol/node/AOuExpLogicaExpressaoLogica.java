...
public final class AOuExpLogicaExpressaoLogica extends PExpressaoLogica
{
    private PExpressaoLogica _expressaoLogica_;
    private TOu _ou_;
    private PExpsLogicas _expsLogicas_;

    public AOuExpLogicaExpressaoLogica()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AOuExpLogicaExpressaoLogica(
    ...
    {
        ((Analysis) sw).caseAOuExpLogicaExpressaoLogica(this);
    }

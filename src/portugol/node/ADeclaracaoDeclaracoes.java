...
public final class ADeclaracaoDeclaracoes extends PDeclaracoes
{
    private PDeclaracao _declaracao_;

    public ADeclaracaoDeclaracoes()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ADeclaracaoDeclaracoes(
    ...
    {
        ((Analysis) sw).caseADeclaracaoDeclaracoes(this);
    }
